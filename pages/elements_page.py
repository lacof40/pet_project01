...
from locators.element_page_locators import TextBoxPageLocators, CheckBoxPageLocators, RadioButtonPageLocators, \
    WebTablePageLocators, ButtonsPageLocators, LinksPageLocators, TestUploadAndDownloadLocators, \
...
class RadioButtonPage(BasePage):
    ...
    def click_on_the_radio_button(self, choice):
        choices = {'yes': self.locators.YES_RADIOBUTTON, 'impressive': self.locators.IMPRESSIVE_RADIOBUTTON,
...
class TestUploadAndDownloadPage(BasePage):
    locators = TestUploadAndDownloadLocators()
    ...
    def download_file(self):
        ...
        path_name_file = fr'/Users/an.sinkov/PycharmProjects/pet_project01/{random.randint(0, 999)}.jpg'
...
class DynamicPropertiesPage(BasePage):
    ...
    @allure.step('check appeared button')
